...
# proxy client --- Proxy server --- google.com
...
def start_server():
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
        ...
        server_socket.listen(2) # tells our program how much of a queue to allow
        conn, addr = server_socket.accept() # conn is another socket
